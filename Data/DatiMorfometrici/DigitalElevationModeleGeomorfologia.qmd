...
df<- read_excel("Indici-morfometrici (3).xlsx")
colnames(df) <- df[1, ] 
df <- df[-1, ]  
#rownames(df) <- NULL
#head(df)
...
library(leaflet)
library(sf)
#https://public.opendatasoft.com/explore/dataset/georef-italy-comune/export/?utm_source=chatgpt.com&disjunctive.rip_code&disjunctive.rip_name&disjunctive.reg_code&disjunctive.reg_name&disjunctive.prov_code&disjunctive.prov_name&disjunctive.com_code&disjunctive.com_name&sort=year&location=6,42.66628,16.33667&basemap=jawg.light
